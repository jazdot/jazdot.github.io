...
import { GraduationCap, Gauge, Wrench, TerminalSquare, Activity } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <ToolModal
        ...
        title={activeTool === 'speedTest' ? 'Network Speed Test' : activeTool === 'terminal' ? 'Terminal' : activeTool === 'infraHealth' ? 'System Health Dashboard' : ''}
      >
