...
import { GraduationCap, Gauge, Wrench, TerminalSquare, Activity, Network } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <ToolModal
        ...
        title={activeTool === 'speedTest' ? 'Network Speed Test' : activeTool === 'terminal' ? 'Terminal' : activeTool === 'infraHealth' ? 'System Health Dashboard' : activeTool === 'topology' ? 'Interactive Network Topology' : ''}
      >
